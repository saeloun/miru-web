...
export const orgSettingsSelectors ={
  ...
  address: dataCy('address'),
  standardRate: dataCy('standard-rate'),
  country: dataCy('country'),
  baseCurrency: dataCy('base-currency'),
  timezone: dataCy('timezone'),
  dateFormat: dataCy('date-format'),
  fiscalYear: dataCy('fiscal-year')
}
