...
Threshold notifications run once per week on Monday at 1:00 AM Eastern time. Duplicate notifications are suppressed for one week per company and alert type.
