# Integration Coverage Matrix (API + System Specs)
...
| Resource | Routes (API v1) | Request Coverage | System Coverage | Status | Notes |
|---|---|---|---|---|---|
| clients | index/show/create/update/destroy | yes | yes (`spec/system/clients/*`) | full | Includes invoice sub-endpoints |
| projects | index/show/create/update/destroy | yes | yes (`spec/system/projects/*`) | full | Includes search endpoint |
| invoices | index/show/create/update/destroy/edit + actions | yes | yes (`spec/system/invoices/*`) | full | Includes send/download/bulk endpoints |
| timesheet_entries | index/create/update/destroy + bulk actions | yes | yes (`spec/system/time_tracking/*`) | full | CRUD + bulk coverage present |
| expenses | index/show/create/update/destroy | yes | yes (`spec/system/expenses/*`) | full | Added update/destroy request coverage |
| team | index/update/destroy (+details/avatar) | yes | yes (`spec/system/teams/*`) | full | Split across team/member endpoints |
...
| invitations | create/update/destroy + resend | yes | partial | full (API), partial (system) | Added update/destroy/resend request coverage |
...
|---|---|---|---|
| reports (client_revenues, time_entries, outstanding_overdue_invoices, accounts_aging, payments) | request + system | good | Download/index coverage present for major report types |
| dashboard | request + system | good | overview/stats covered |
| workspaces | request | good | index/update covered |
...
| holidays | request + system | good | navigation and update flows covered |
...
| UI/system flow | yes | `spec/system/invoice_pdf_download_spec.rb` |
