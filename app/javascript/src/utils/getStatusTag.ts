const getStatusCssClass = (status) => {
  const STATUS_LIST = {
    ...
    billed: "bg-miru-alert-blue-400 text-miru-alert-blue-1000",
    unbilled: "bg-miru-alert-blue-400 text-miru-alert-blue-1000",
    nonbilled: "bg-miru-alert-blue-400 text-miru-alert-blue-1000"
  };
