const en = {
  ...
  customRangeWithDates: "Custom (%{from} - %{to})",
  ...
  clients: {
    ...
    acceptedPngAndJpgFormats: "Accepted file formats: PNG and JPG.",
    fileSizeLimitKb: "File size should be ≤ %{fileSize} KB.",
  ...
  payments: {
    ...
    searchPaymentsPlaceholder:
      "Search payments by client, invoice, or amount...",
    ...
    failedToLoadInvoicesForPaymentEntry:
      "Failed to load invoices for payment entry",
    ...
    paymentHistoryDescription: "Every payment with invoice and client details.",
    paymentLedgerDescription: "Stripe and manual entries in one simple ledger.",
  ...
  orgSetup: {
    ...
    mostSelectedCountries: "Most selected countries",
    selectCountryGroup: "Please select",
  },
  organization: {
    updateError: "Error in updating organization details",
    basicDetails: "Basic Details",
    companyLogo: "Company Logo",
    dropLogoHere: "Drop logo here or click to upload",
    logoFormats: "JPG, PNG or GIF (max. 2MB)",
    companyName: "Company Name",
    enterCompanyName: "Enter company name",
    businessPhone: "Business Phone",
    address: "Address",
  ...
  invoiceHistory: {
    ...
    viewedInvoice: "viewed invoice",
    updatedInvoice: "updated invoice",
    deletedInvoice: "deleted invoice",
    downloadedInvoice: "downloaded invoice",
    sentInvoice: "sent invoice",
    markedInvoicePaidManually: "marked invoice as paid manually",
  ...
  employment: {
    validation: {
      ...
      dateOfJoiningRequired: "Please enter Date of joining",
      max20: "Maximum 20 characters are allowed",
      max40: "Maximum 40 characters are allowed",
    },
  },
  timeSlots: {
  ...
  paymentSettingsPage: {
    ...
    paypalSupportedCurrencies:
      "Shown on invoices in PayPal-supported currencies (USD, EUR, GBP, AUD, CAD, and more). Not available for INR.",
    ...
    invalidUpiId: "Enter a valid UPI ID, for example name@bank.",
    ...
    payoutAccountNumber: "RazorpayX account number",
    payoutUpiId: "UPI payout ID",
    payoutPurpose: "Payout purpose",
    upiPayouts: "UPI payouts",
    queuePayouts: "Queue low-balance payouts",
    saveRazorpay: "Save Razorpay",
    savingRazorpay: "Saving...",
  ...
  auth: {
    ...
    validation: {
      ...
      max50: "Maximum 50 characters are allowed",
      countryRequired: "Country cannot be blank",
      stateRequired: "State cannot be blank",
      cityRequired: "City cannot be blank",
      zipcodeRequired: "Zipcode cannot be blank",
      zipcodeLineRequired: "Zipcode line cannot be blank",
      ...
      amountMustBePositive: "Please enter a larger amount",
      rateRequired: "Rate cannot be blank",
      workingHoursRequired: "Working hours cannot be blank",
      workingDaysRequired: "Working days cannot be blank",
      firstNamePrompt: "Please enter first name",
      lastNamePrompt: "Please enter last name",
      addressLine1Prompt: "Please enter address line 1",
      countryPrompt: "Please enter country",
      statePrompt: "Please enter state",
      cityPrompt: "Please enter city",
      zipcodePrompt: "Please enter zipcode",
      validEmailPrompt: "Please enter valid email",
      dateOfBirthFuture: "Date of birth cannot be in the future",
      mobileMin2Digits: "Mobile number must contain at least 2 digits",
      mobile15Digits: "Mobile number cannot exceed 15 digits",
      passwordPrompt: "Please enter password",
      currentPasswordPrompt: "Please enter current password",
