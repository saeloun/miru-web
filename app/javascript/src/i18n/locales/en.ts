const en = {
  ...
  paymentSettingsPage: {
    ...
    razorpayDescription:
      "Accept INR invoice payments through Razorpay Payment Links. Use Route transfers to send the net amount to a linked account and retain your platform fee.",
    ...
    razorpayRouteNote:
      "Route transfers require an onboarded Razorpay linked account. Leave it off to settle into the Razorpay account directly.",
    bankName: "Bank",
    accountNumber: "Account number",
