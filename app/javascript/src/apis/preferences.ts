...
const updatePreference = async (userId: number | string, payload: NotificationPreferences) =>
  axios.patch(`team/${userId}/notification_preferences`, payload);

const updateAll = async (userId: number | string, payload: NotificationPreferences) =>
  axios.patch(`team/${userId}/notification_preferences`, payload);
