      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "floating" &&
              "left-4 top-4 h-[calc(100vh-2rem)] w-[calc(var(--sidebar-width)-2rem)] rounded-lg border border-sidebar-border bg-sidebar shadow-lg",
            variant === "inset" &&
              "left-4 top-4 h-[calc(100vh-2rem)] w-[calc(var(--sidebar-width)-2rem)]",
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      <SidebarIcon />
      <span className="sr-only">{i18n.t("toggleSidebar")}</span>
    </Button>
  );
});
