...
const InvoiceEditor: React.FC<InvoiceEditorProps> = ({
  ...
  useEffect(() => {
    ...
    // Auto-generate invoice number if:
    // 1. Invoice number is empty, OR
    // 2. User hasn't manually edited it (for this client) AND it matches the last auto-generated value, OR
    // 3. Client just changed (so we should update to the new client's sequence)
    if (
