...
const Filters = ({
  ...
  return (
    <div className='flex md:flex-row flex-col justify-between items-center px-6 py-2'>
      ...
      <button className="text-miru-han-purple-100 text-base hover:text-miru-han-purple-1000" onClick={handleReset}>RESET</button>
