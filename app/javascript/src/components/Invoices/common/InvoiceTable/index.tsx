...
const InvoiceTable = ({
  ...
  const [showMultiLineItemModal, setMultiLineItemModal] =
  ...
  const getAddNewButton = () => {
    if (addNew) {
      return (
        <div
          ref={wrapperRef}
          className="box-shadow rounded absolute m-0 font-medium text-sm text-miru-dark-purple-1000 bg-white top-0 w-full"
        >
