    ...
    <div className="flex justify-center min-h-screen items-center">
      <div className="w-96 p-6 shadow-xl rounded bg-white">
        ...
        <div className="flex justify-between items-center mt-6">
          <label className="text-miru-dark-purple-1000 text-xs">
            Number of Team Members:{" "}
          </label>
          <input
            className="w-40 bg-miru-gray-100 rounded text-right p-1"
        ...
        <div className="bg-miru-gray-100 p-4 my-6">
          <div className="border-b pb-4 mb-4">
            ...
            <div className="flex justify-between">
              <h5 className="text-miru-dark-purple-1000 text-base font-semibold">
                Basic Plan
              </h5>
              <span className="text-miru-dark-purple-1000 text-base font-semibold">
                {plan.details.cost}$
              </span>
            </div>
            <div className="flex justify-between">
              <p className="text-miru-dark-purple-400 text-xs">
                Basic plan includes all features. <br /> This is a one-time
                charge.
              </p>
              <span className="text-miru-dark-purple-400 text-xs text-right">
                charged once
              </span>
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between">
              <h5 className="text-miru-dark-purple-1000 text-2xl font-semibold">
                Total
              </h5>
              <div className="text-right">
                ...
                <span className="text-miru-dark-purple-400 text-xs">
                  plus taxes
                </span>
              </div>
            </div>
