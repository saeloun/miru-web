...
const NewSkypeDMTimeline = ({ leadDetails, setNewSkypeDMTimeline, timelineData, setTimelineData }) => {
  ...
  return (
    <Dialog title="Add New Action : Skype DM" open={true} onClose={() => { setNewSkypeDMTimeline(false); }}>
      <Formik
