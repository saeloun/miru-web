...
const newOtherDMTimelineSchema = Yup.object().shape({
...
const NewOtherDMTimeline = ({ candidateDetails, setNewOtherDMTimeline, timelineData, setTimelineData }) => {
        ...
        <div className="relative w-full h-full px-4 md:flex md:items-center md:justify-center">
          <div className="px-6 pb-6 transition-all transform bg-white rounded-lg shadow-xl sm:align-middle sm:max-w-md modal-width">
            <div className="flex items-center justify-between mt-6">
              <h6 className="text-base font-extrabold">Add New Action : Other DM</h6>
              <button type="button" onClick={() => { setNewOtherDMTimeline(false); }}>
                <X size={16} color="#CDD6DF" weight="bold" />
              </button>
            </div>
            <Formik
              initialValues={initialValues}
              validationSchema={newOtherDMTimelineSchema}
              ...
              {({ errors, touched }) => (
                <Form>
                  ...
                  <div className="mt-2.5">
                    <div className="field">
                      <div className="field_with_errors">
                        <label className="form__label">Other ID</label>
                        <div className="block text-xs tracking-wider text-red-600">
...
export default NewOtherDMTimeline;
