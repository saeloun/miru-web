  ...
  if (consultancies) {
    return consultancies.map((consultancy) =>
      ({
        ...
        col2: <div className="text-base text-miru-dark-purple-1000 text-center">{consultancy.email}</div>,
        col3: <div className="text-base text-miru-dark-purple-1000 text-center">{consultancy.address}</div>,
        col4: <div className="text-base text-miru-dark-purple-1000 text-center">{consultancy.phone}</div>,
