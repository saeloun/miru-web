...
const BankDetails = ({
  ...
  return (
    <>
      <div className="justify-center items-center flex overflow-XIcon-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
          ...
          <div className="rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-center justify-center px-5 rounded-b text-white font-bold text-sm">
              <button
                ...
                className={`w-full background-transparent uppercase rounded-md px-6 py-2 outline-none mb-3 ease-linear transition-all duration-150 ${
