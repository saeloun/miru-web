...
import { allocationFrequency, allocationPeriod } from "constants/leaveType";
                  ...
                  <CustomReactSelect
                    ...
                    value={
                      leaveBalance.allocationPeriod
                        ? allocationPeriod.filter(
                            option =>
                              option.value === leaveBalance.allocationPeriod
                          )
                        : allocationPeriod[0]
                    }
                  />
                    ...
                    value={
                      leaveBalance.allocationFrequency
                        ? allocationFrequency.filter(
                            option =>
                              option.value === leaveBalance.allocationFrequency
                          )
