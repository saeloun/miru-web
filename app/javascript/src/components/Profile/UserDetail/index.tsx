            ...
            <div className="w-full p-2">
              <div>
                {!changePassword && (
                  <div>
                    <p
                      className=" text-miru-han-purple-1000 cursor-pointer"
                    ...
                    <div className="flex flex-col">
                      <div className="flex flex-col w-1/2 pr-2">
                        ...
                        <div className="flex relative items-center">
                          ...
                          />
                          <button
                            className="btn btn-outline-primary absolute mt-2 mr-3 right-0"
                            onClick={() =>
                              setShowCurrentPassword(!showCurrentPasword)
                            }
                          >
                            {!showCurrentPasword ? (
                        ...
                        <div className="flex flex-col w-1/2 pl-2 mt-2">
                          ...
                          <div className="flex relative items-center">
                            ...
                            <button
                              className="btn btn-outline-primary absolute mt-2 mr-3 right-0"
                              onClick={() =>
                                setShowConfirmPassword(!showConfirmPasword)
                              }
                            >
                              {!showConfirmPasword ? (
                                <img src={password_icon} alt="pass_icon" />
                      ...
                      <p
                        className="mt-5 text-miru-han-purple-1000 cursor-pointer"
