    ...
    <>
      <tr className="group block last:border-b-0 md:hidden">
        <td className="w-full pt-2 pr-6 pl-0 text-left">
          ...
          <h3 className="pt-1 font-sans text-xs font-medium leading-4 text-miru-dark-purple-400">
            {invoiceNumber}
          </h3>
        </td>
        <td className="w-full pt-2.125 pl-0">
          <div className="text-right">
            <Badge
              ...
              text={status}
            />
            <h3 className="pt-1 font-sans text-sm font-medium leading-5 text-miru-dark-purple-1000">
      ...
      <tr className="w-full border-none">
        <td className="border-none">
          <h3 className="pt-1.5 pb-1 font-sans text-xs font-medium leading-4 text-miru-dark-purple-400">
            {transactionType}
          </h3>
        </td>
      </tr>
