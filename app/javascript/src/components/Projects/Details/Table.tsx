    ...
    return (
      <div className="flex items-center">
        ...
        <div className="bg-white border-2 border-miru-han-purple-1000 w-5 h-5 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-blue-500">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="fill-current w-2 h-2 text-miru-han-purple-1000 pointer-events-none" viewBox="0 0 17 12">
            <g fill="none" fillRule="evenodd">
              <line x1="10" y1="10" x2="300" y2="10" stroke="red" stroke-width="10"/>
            </g>
          </svg>
...
const Table = ({ tableHeader, tableRowArray }) => {
        ...
        {headerGroups.map(headerGroup => (
          <tr {...headerGroup.getHeaderGroupProps()}>
            {headerGroup.headers.map(column => (
              <th className="table__header" {...column.getHeaderProps()}>{column.render('Header')}</th>
            ))}
          </tr>
        ))}
      </thead>
