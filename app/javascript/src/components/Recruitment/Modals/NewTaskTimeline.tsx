...
const NewTaskTimeline = ({ candidateDetails, setNewTaskTimeline, timelineData, setTimelineData }) => {
  ...
  return (
    <Dialog title="Add New Task" open={true} onClose={() => { setNewTaskTimeline(false); }}>
      <Formik
