...
const NewPhoneCallTimeline = ({ candidateDetails, setNewPhoneCallTimeline, timelineData, setTimelineData }) => {
  ...
  return (
    <Dialog title="Add New Action : Phone Call" open={true} onClose={() => { setNewPhoneCallTimeline(false); }}>
      <Formik
