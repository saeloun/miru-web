...
const NewAppointmentTimeline = ({ candidateDetails, setNewAppointmentTimeline, timelineData, setTimelineData }) => {
  ...
  return (
    <Dialog title="Add New Appointment" open={true} onClose={() => { setNewAppointmentTimeline(false); }}>
      <Formik
