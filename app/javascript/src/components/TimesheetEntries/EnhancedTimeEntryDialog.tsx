    ...
    queryFn: async () =>
      ...
      ({
        ...
        projects: [
          ...
          {
            id: 4,
            name: "Voyatouch Testing",
            client: "Marvin, Windler and Wintheiser",
            clientId: 2,
            billable: false,
          },
          {
            id: 5,
            name: "Voyatouch Development",
            client: "Marvin, Windler and Wintheiser",
            clientId: 2,
            billable: true,
          },
          {
            ...
            client: "Prohaska, Collier and Pollich",
            clientId: 3,
            billable: true,
          },
          {
