...
const TableRow = ({ currency, report }) => {
  ...
  return (
    <tr className="flex flex-row items-center" key={id}>
      ...
      <td className="w-2/12 whitespace-pre-wrap px-0 py-4 text-right text-base font-normal text-foreground">
      ...
      <td className="w-2/12 whitespace-nowrap py-4 pl-0 text-right text-xl font-bold text-foreground">
