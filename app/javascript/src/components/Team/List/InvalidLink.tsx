  ...
  return (
    <div className=" relative flex min-h-screen w-full flex-col items-center justify-center px-8 md:px-0 ">
      <div className="mx-auto min-h-full md:w-5/12 lg:w-352">
        <h1 className="text-center font-sans text-xl font-bold text-miru-dark-purple-1000 md:text-3xl lg:text-3.5xl">
          The link is not valid
          <br />
        </h1>
        <div className="pt-10">
          <p className="text-center font-sans text-2xl text-miru-dark-purple-1000 ">
