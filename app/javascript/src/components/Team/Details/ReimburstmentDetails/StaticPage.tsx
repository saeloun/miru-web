    ...
    <table className="w-full">
      ...
      <tbody>
        <tr className="flex flex-row items-center items-center border-b border-miru-gray-400">
          ...
          <td className="w-4/12 reiTable__tr">Medium annual team subscription</td>
          ...
          <td className="w-2/12 reiTable__tr">
            <button className="ml-5"><PenIcon size={16} color="#5B34EA" /></button>
            <button className="ml-5"><DeleteIcon size={16} color="#5B34EA" /></button>
          </td>
        </tr>
