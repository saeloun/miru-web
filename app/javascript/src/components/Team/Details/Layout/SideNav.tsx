...
const UserInformation = () => (
  <div>
    <div className="mr-2 w-60 h-20 p-4 bg-miru-han-purple-1000 flex text-white items-center"></div>
    <div className="bg-miru-gray-100 flex flex-col justify-center mr-2">
      ...
      <div className="flex flex-col justify-center items-center mt-3 pb-8 border-b-8 border-miru-gray-200">
        <span className="text-miru-han-purple-1000 text-xl font-bold mb-1">
          Jane Cooper
        </span>
        <span className="text-miru-dark-purple-1000 text-xs tracking-wider leading-4">
