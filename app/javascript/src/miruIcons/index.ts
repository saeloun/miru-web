...
export const SpaceIcon = Planet;
export const TackleIcon = Swap;
export const LeadIcon = Leaf;
export const EngagementIcon = Equalizer;
export const RecruitmentIcon = UserSwitch;
