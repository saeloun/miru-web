...
const checkbox = require("../../../assets/images/checkbox-unchecked.svg");
...
const error = require("../../../assets/images/error-octagon.svg");
...
export const PasswordIcon_textSVG = password_icon_text;
