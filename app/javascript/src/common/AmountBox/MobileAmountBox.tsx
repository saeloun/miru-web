  ...
  <div className="block px-4 lg:hidden">
    <div className="bg-miru-gray-100 p-2">
      <table className="w-full">
        <thead className="text-left font-sans text-xxs not-italic tracking-2 text-miru-dark-purple-1000">
          <tr>
        ...
        <tbody className="text-left font-sans text-2xl font-bold not-italic">
          <tr>
