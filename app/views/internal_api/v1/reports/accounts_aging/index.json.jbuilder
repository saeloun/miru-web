...
json.report do
  json.clients clients do |client|
    ...
    json.amount_overdue do
      json.zero_to_thirty_days client.invoices.overdue.during(1.month.ago..Date.today).pluck(:amount_due).sum
      json.thirty_one_to_sixty_days client.invoices.overdue.during(2.month.ago..1.month.ago).pluck(:amount_due).sum
      json.sixty_one_to_ninety_days client.invoices.overdue.during(3.month.ago..2.month.ago).pluck(:amount_due).sum
