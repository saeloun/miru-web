...
json.clients clients do |client|
  ...
  json.outstanding_amount client[:unpaid_amount]
  json.overdue_amount client[:overdue_amount]
  json.total_amount client[:paid_amount] + client[:unpaid_amount] + client[:overdue_amount]
end
json.summary do
  json.total_paid_amount summary[:total_paid_amount]
  json.total_outstanding_amount summary[:total_unpaid_amount]
