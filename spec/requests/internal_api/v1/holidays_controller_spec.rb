...
RSpec.describe InternalApi::V1::HolidaysController, type: :request do
  ...
  describe "GET #index" do
    it "returns all holidays for the company" do
      ...
      get internal_api_v1_holidays_path, headers: auth_headers(user)
  ...
  describe "PUT #update" do
    context "with valid parameters" do
      ...
      it "updates holidays successfully" do
        put internal_api_v1_holiday_path(year), params: valid_params, headers: auth_headers(user)
    ...
    context "with invalid parameters" do
      ...
      it "returns unprocessable entity status" do
        put internal_api_v1_holiday_path(year), params: invalid_params, headers: auth_headers(user)
    ...
    context "with special characters in holiday name" do
      ...
      it "accepts hyphens in holiday names" do
        put internal_api_v1_holiday_path(year), params: params_with_hyphen, headers: auth_headers(user)
      ...
      it "accepts apostrophes in holiday names" do
        put internal_api_v1_holiday_path(year), params: params_with_apostrophe, headers: auth_headers(user)
    ...
    context "when updating existing holiday info" do
      ...
      it "updates existing holiday info" do
        put internal_api_v1_holiday_path(year), params: update_params, headers: auth_headers(user)
      ...
      context "with invalid update" do
        ...
        it "returns unprocessable entity status" do
          put internal_api_v1_holiday_path(year), params: invalid_update_params, headers: auth_headers(user)
