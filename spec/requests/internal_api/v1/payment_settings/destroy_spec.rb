...
RSpec.describe "InternalApi::V1::PaymentSettings#destroy", type: :request, vcr: true do
  ...
  context "when user is an admin" do
    ...
    it "is able to delete a stripe connection" do
      expect {
        send_request :delete, internal_api_v1_payments_settings_stripe_disconnect_path, headers: auth_headers(user)
