...
RSpec.describe InternalApi::V1::TimezonesController, type: :request do
  ...
  describe "GET index" do
    context "when user is an admin" do
      ...
      subject { send_request :get, internal_api_v1_timezones_path, headers: auth_headers(admin) }
    ...
    context "when user is an employee" do
      ...
      subject { send_request :get, internal_api_v1_timezones_path, headers: auth_headers(employee) }
    ...
    context "when user is a book_keeper" do
      ...
      subject { send_request :get, internal_api_v1_timezones_path, headers: auth_headers(book_keeper) }
