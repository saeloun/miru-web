...
RSpec.describe InternalApi::V1::PaymentsController, type: :request do
    ...
    context "with search query" do
      context "searching by client name" do
        ...
        it "performs case-insensitive search" do
          get "/internal_api/v1/payments", params: { query: "TECH" }
      ...
      context "searching by invoice number" do
        it "returns payments matching the invoice number" do
          get "/internal_api/v1/payments", params: { query: "INV-002" }
        ...
        it "supports partial invoice number search" do
          get "/internal_api/v1/payments", params: { query: "001" }
      ...
      context "searching by amount" do
        it "returns payments matching the amount" do
          get "/internal_api/v1/payments", params: { query: "2500" }
      ...
      context "with no matching results" do
        it "returns empty array when no payments match" do
          get "/internal_api/v1/payments", params: { query: "NonExistent" }
  ...
  describe "POST #create" do
    ...
    context "with valid params" do
      it "creates a new payment" do
        expect {
          post "/internal_api/v1/payments", params: valid_payment_params
    ...
    context "with invalid params" do
      it "returns error when invoice_id is missing" do
        ...
        post "/internal_api/v1/payments", params: invalid_params
  ...
  describe "GET #new" do
    it "returns list of unpaid invoices" do
      ...
      get "/internal_api/v1/payments/new"
