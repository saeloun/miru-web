...
RSpec.describe "InternalApi::V1::TimesheetEntry::BulkActionController#update", type: :request do
  ...
  describe "#update" do
    before do
      ...
      send_request :patch, internal_api_v1_bulk_action_path, params:, headers: auth_headers(user)
    end
