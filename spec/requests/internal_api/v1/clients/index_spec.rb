    ...
    context "for ransack search" do
      ...
      it "finds specific client by name" do
        client_details = [{
          ...
          minutes_spent: client_1.total_hours_logged(time_frame), client_logo: ""
        }]
        expect(response).to have_http_status(:ok)
    ...
    it "returns all the clients when query params are empty" do
      client_details = [{
        ...
        minutes_spent: client_1.total_hours_logged(time_frame), client_logo: ""
         ...
         minutes_spent: client_2.total_hours_logged(time_frame), client_logo: "" ]
        ...
        client_details = user.current_workspace.clients.kept.map do |client|
          {
            ...
            minutes_spent: client.total_hours_logged(time_frame), client_logo: ""
          }
        end
