...
RSpec.describe "InternalApi::V1::Employments#show", type: :request do
  ...
  context "when user is an admin" do
    before do
      ...
      sign_in user
      get internal_api_v1_employment_path(user), headers: auth_headers(user)
    end
    ...
    it "returns the employment details" do
      ...
      expect(json_response["employment"]["resigned_at"]).to eq(employment.resigned_at)
