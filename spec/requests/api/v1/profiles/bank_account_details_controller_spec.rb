...
RSpec.describe "Api::V1::Profiles::BankAccountDetailsController", type: :request do
  ...
  describe "GET index" do
    subject { send_request :get, api_v1_profiles_bank_account_details_path, headers: auth_headers(user) }
    ...
    context "when user is not authorized" do
      before do
        allow_any_instance_of(Api::V1::Profiles::BankAccountDetailsController)
  ...
  describe "POST create" do
    subject {
  send_request :post, api_v1_profiles_bank_account_details_path(params:), headers: auth_headers(user)
}
  ...
  describe "PUT update" do
    subject {
  send_request :put, api_v1_profiles_bank_account_detail_path(account_id:, params:),
