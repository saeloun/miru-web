...
RSpec.describe "Api::V1::Reports::OutstandingOverdueInvoicesController::#index", type: :request do
  ...
  context "when user is an admin" do
    ...
    context "when outstanding and overdue invoices reports page's request is made" do
      before do
        ...
        get api_v1_reports_outstanding_overdue_invoices_path, headers: auth_headers(user)
      end
  ...
  context "when user is an employee" do
    before do
      ...
      sign_in user
      send_request :get, api_v1_reports_outstanding_overdue_invoices_path, headers: auth_headers(user)
    end
  ...
  context "when unauthenticated" do
    it "is not permitted to view outstanding and overdue invoices report" do
      send_request :get, api_v1_reports_outstanding_overdue_invoices_path
