...
RSpec.describe "Api::V1::Reports::TimeEntryController::#index", type: :request do
  ...
  context "when user is an admin" do
    ...
    context "when reports page's request is made without any filters" do
      before do
        ...
        get api_v1_reports_time_entries_path, headers: auth_headers(user)
      end
    ...
    context "when reports page's request is made with date range filter" do
      ...
      it "returns the time entry reports in given date range in descending order" do
        send_request :get, api_v1_reports_time_entries_path, params: {
  ...
  context "when user is an employee" do
    before do
      ...
      sign_in user
      send_request :get, api_v1_reports_time_entries_path, headers: auth_headers(user)
    end
  ...
  context "when unauthenticated" do
    it "is not permitted to view time entry report" do
      send_request :get, api_v1_reports_time_entries_path
