...
RSpec.describe Api::V1::Invoices::RecentlyUpdatedController, type: :request do
  ...
  describe "GET #index" do
    context "when invoices exist" do
      ...
      it "returns recently updated invoices in descending order" do
        get api_v1_invoices_recently_updated_index_path
      ...
      it "returns correct metadata" do
        get api_v1_invoices_recently_updated_index_path, params: { per_page: 10 }
      ...
      it "includes client information" do
        get api_v1_invoices_recently_updated_index_path, params: { per_page: 1 }
    ...
    context "with status filter" do
      ...
      it "filters by status when provided" do
        get api_v1_invoices_recently_updated_index_path, params: { status: "draft" }
    ...
    context "with days_ago filter" do
      ...
      it "filters by days_ago when provided" do
        get api_v1_invoices_recently_updated_index_path, params: { days_ago: 7 }
    ...
    context "with pagination edge cases" do
      it "handles invalid page gracefully" do
        get api_v1_invoices_recently_updated_index_path, params: { page: 999 }
      ...
      it "limits per_page to maximum" do
        get api_v1_invoices_recently_updated_index_path, params: { per_page: 100 }
