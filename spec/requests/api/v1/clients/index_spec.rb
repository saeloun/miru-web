...
RSpec.describe "Api::V1::Clients#index", type: :request do
  ...
  context "when user is an admin" do
    before do
      ...
      send_request :get, api_v1_clients_path, headers: auth_headers(user)
    end
    ...
    context "for search" do
      before do
        ...
        user.add_role :admin, company
        sign_in user
        send_request :get, api_v1_clients_path, params: { query: client_1.name }, headers: auth_headers(user)
      end
  ...
  context "when user is an employee" do
    ...
    before do
      ...
      create_list(:timesheet_entry, 5, user:, project: project_1)
      create_list(:timesheet_entry, 5, user:, project: project_2)
      send_request :get, api_v1_clients_path, params: {
