...
RSpec.describe "Api::V1::Clients#show", type: :request do
  ...
  context "when user is an admin" do
    before do
      ...
      send_request :get, api_v1_client_path(client_1), headers: auth_headers(user)
    end
  ...
  context "when unauthenticated" do
    it "is not permitted to view client details" do
      send_request :get, api_v1_client_path(client_1)
