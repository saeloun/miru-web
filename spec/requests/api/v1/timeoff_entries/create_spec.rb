...
RSpec.describe "Api::V1::TimeoffEntry#create", type: :request do
  ...
  context "when user is an admin" do
    ...
    describe "#create" do
      ...
      it "throws unprocessable_content error if required attributes are missing" do
        ...
        send_request :post, api_v1_timeoff_entries_path(timeoff_entry: invalid_timeoff_entry_attributes),
  ...
  context "when unauthenticated" do
    it "is not be permitted to add timeoff entry" do
      send_request :post, api_v1_timeoff_entries_path
