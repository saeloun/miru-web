...
#         send_request :get,
#           api_v1_projects_path(params: { client_id:, user_id:, billable:, search: }),
...
#       send_request :get, api_v1_projects_path
...
# # shared_examples_for "Api::V1::Projects#index project list" do
# #   it "projects" do
# #     subject
# #     expect(response).to have_http_status(:ok)
# #     expect(json_response["projects"]).to eq(project_list)
...
# #   end
# #
# #   subject { send_request :get, api_v1_projects_path(params:) }
# #
# #   let(:company) { create(:company) }
...
# #       it_behaves_like "Api::V1::Projects#index project list"
# #     end
# #
