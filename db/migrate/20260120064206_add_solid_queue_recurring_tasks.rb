  ...
  def change
    safety_assured do
      ...
      add_index :solid_queue_processes, [:name, :supervisor_id], unique: true,
        name: "index_solid_queue_processes_on_name_and_supervisor_id", algorithm: :concurrently
      ...
      add_index :solid_queue_recurring_tasks, :key, unique: true, algorithm: :concurrently
      add_index :solid_queue_recurring_tasks, :static, algorithm: :concurrently
    end
  end
end
