...
# Projects Start
common_client_IN, common_client_US, client_one_company_India, client_one_company_US = Client.first(4)
...
common_client_US.projects.create!(projects[1])
client_one_company_India.projects.create!(projects[2])
