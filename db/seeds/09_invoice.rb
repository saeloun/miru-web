...
invoice_1_india = {
  ...
  amount_due: 1000, discount: 500, status: 0, client_id: @client_1_saeloun_india.id
}
invoice_2_india = {
  ...
  amount: 5000, outstanding_amount: 2000, tax: 500, amount_paid: 3000,
  amount_due: 1000, discount: 500, status: 1, client_id: @client_1_saeloun_india.id
}
invoice_3_india = {
  ...
  amount: 5000, outstanding_amount: 2000, tax: 500, amount_paid: 3000,
  amount_due: 1000, discount: 500, status: 2, client_id: @client_2_saeloun_india.id
}
